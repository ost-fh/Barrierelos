...
class ControllerTests(@Autowired val mockMvc: MockMvc)
{
  ...
  @Nested
  inner class ReportMessageControllerTests
  {
  ...
  @Nested
  inner class WebsiteReportControllerTests
  {
    ...
    inner class AddWebsiteReportTests
    {
      ...
      {
        // when
        every { websiteReportService.addWebsiteReport(websiteReport.apply {
          report.reason = ReasonEnum.INCORRECT
          report.state = StateEnum.CLOSED
  ...
  @Nested
  inner class WebpageReportControllerTests
  {
    ...
    inner class AddWebpageReportTests
    {
      ...
      {
        // when
        every { webpageReportService.addWebpageReport(webpageReport.apply {
          report.reason = ReasonEnum.INCORRECT
          report.state = StateEnum.CLOSED
