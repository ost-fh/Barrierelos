...
import ch.barrierelos.backend.constant.Endpoint.DOCUMENTATION_OPENAPI
...
import ch.barrierelos.backend.constant.Endpoint.WEBPAGE_SCAN
import ch.barrierelos.backend.constant.Endpoint.WEBPAGE_STATISTIC
import ch.barrierelos.backend.constant.Endpoint.WEBSITE
import ch.barrierelos.backend.constant.Endpoint.WEBSITES
...
import ch.barrierelos.backend.constant.Endpoint.WEBSITE_STATISTIC
    ...
    return this
      ...
      .authorizeHttpRequests { authorize ->
        authorize
          ...
          .requestMatchers(HttpMethod.GET, "$WEBSITE/region/**").permitAll()
